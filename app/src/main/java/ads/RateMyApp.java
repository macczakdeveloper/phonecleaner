...
public class RateMyApp {
    ...
    public void showRateDialog(final SharedPreferences.Editor editor) {
		...
		titleTextView.setText(callerActivity.getString(R.string.rate_title)+" " + APP_TITLE);
		
		
		String msg = callerActivity.getString(R.string.rate_comment_1)+ " " + APP_TITLE + " " + callerActivity.getString(R.string.rate_comment_2);
